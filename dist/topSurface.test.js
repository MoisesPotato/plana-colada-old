...
describe('Cells ', () => {
    ...
    it('glues 0-cells in 0-cells', () => {
        expect(TopSurface_1.Cell.glue0(v1, [v1], v2)).toEqual(v2);
        expect(TopSurface_1.Cell.glue0(v1, [v2], v1)).toEqual(v1);
        expect(TopSurface_1.Cell.glue0(v1, [v2], v2)).toEqual(v1);
        expect(TopSurface_1.Cell.glue0(v1, [v1, v2], v2)).toEqual(v2);
        expect(TopSurface_1.Cell.glue0(v1, [], v2)).toEqual(v1);
    });
    it('glues 0-cells in 1-cells', () => {
        console.log(`e1: ${e1.toString()}`);
        const e3 = TopSurface_1.Cell.glue0(e1, [], v1);
        // console.log('Made e3');
        // console.log(`e1: ${e1.toString()}`);
        expect(e3).toEqual(e1);
        expect(e1.start.toString()).toEqual('e1-start');
        const e4 = TopSurface_1.Cell.glue0(e1, [e1.start, e1.end], e1.start);
        expect(e4.cells0);
        ...
        // console.log('Made e4');
        // console.log(`e1: ${e1.toString()}`);
        let e5 = TopSurface_1.Cell.glue0(e1, [e1.end], v2);
        expect(e5.start).toEqual(e1.start);
        expect(e5.end).toEqual(v2);
        // console.log(`e5: ${e5.toString()}`);
        e5 = TopSurface_1.Cell.glue0(e5, [e1.start], v1);
        // console.log(`e5: ${e5.toString()}`);
