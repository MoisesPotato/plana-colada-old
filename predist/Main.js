...
class GameStatus {
    ...
    drawObjects(u) {
        ...
        u.objectList.forEach((o) => drawObj(o, this, u));
        u.domain.walls.forEach((wall) => wall.draw(this));
    }
    /**
...
class UniverseInfo {
    ...
    move(g) {
        ...
        if (!this.speed.isZero() && !isNaN(M.matrix[1][0].re)) {
            this.objectList.forEach((o) => o.pos = o.pos.mobius(M));
            this.wallList.forEach((w) => w.moveBy(M));
            this.domain.move(M);
            this.domain.reset();
        }
    }
   ...
   */
    ...
    */
    ...
    move(M) {
        ...
        this.transf.forEach((T) => T = T.mobiusConjugate(M));
    }
    /**
