  ...
  */
  ...
  :number[][] {
    ...
    edges.forEach(({index: index, start: start}, i) => {
      ...
      let newEdgeIndex2 = undefined as number|undefined;
      let newStart2= undefined as boolean|undefined;
      if (faces[1]) {
  ...
  nextEdge(v:number, start:boolean,
      {face: f, index: i}:edgeOf):[number, boolean] {
